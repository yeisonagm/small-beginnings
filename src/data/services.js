export const SERVICES = [
    {
        ...
        src: '/images/services/early-stimulation.jpg',
        points: [
            'Desarrollo en sus habilidades cognitivas, lenguaje y comunicación',
    ...
    },
    {
        ...
        src: '/images/services/clinical-psychology.jpg',
        points: [
            'Evaluación psicológica y tratamiento psicológico.',
            'Diagnóstico y clasificación de trastornos mentales.',
            'Prevención de la salud mental e investigación en psicología clínica.'
        ]
    },
    {
